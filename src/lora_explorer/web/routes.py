...
from ..game.engine import (
    ...
    RUIN_GRACE_DAYS, RUIN_RAMP_DAYS, UPKEEP_GRACE_CAMP, UPKEEP_GRACE_BONUS_DAYS,
    RENOWN_PER_DAY_PER_LEVEL, RENOWN_AGE_BONUS_PER_DAY,
...
async def help_page(request: Request):
    ...
    return await _template(request, "help.html", {
        ...
        "charter_min_level": CHARTER_MIN_LEVEL,
        "charter_min_camp": CHARTER_MIN_CAMP,
        "charter_min_camp_name": camp_name(CHARTER_MIN_CAMP),
        "contracts_min_level": CONTRACTS_MIN_LEVEL,
        "contracts_min_rank_name": rank_name(CONTRACTS_MIN_LEVEL),
        "merchant_min_camp": MERCHANT_MIN_CAMP_LEVEL,
        "merchant_camp_name": camp_name(MERCHANT_MIN_CAMP_LEVEL),
        "buried_cache_amount": BURIED_CACHE_AMOUNT,
        "ruin_grace_days": RUIN_GRACE_DAYS,
        "ruin_ramp_days": RUIN_RAMP_DAYS,
        "upkeep_grace_camp": UPKEEP_GRACE_CAMP,
        "upkeep_grace_bonus": UPKEEP_GRACE_BONUS_DAYS,
        "discovered_relics": discovered_relics,
